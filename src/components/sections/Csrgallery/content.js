...
import instaData from '../../../data/phirseudaan.json';
  ...
  return (
    <div className="ltn__gallery-area mt-5 mb-5">
      <div className="section-title-wrap section-header text-center">
        <h5 className="custom-primary text-center">Impact Moments</h5>
        <h2 className="title text-center">Our Impact in Pictures</h2>
      </div>
